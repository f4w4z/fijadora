      ...
      body: ListView(
        ...
        children: [
          ...
          _section(theme,
            ...
            body: 'Phoebe connects homeowners with qualified service professionals. As a worker, you agree to perform services listed on the platform with professional care and in compliance with all applicable laws and regulations.',
          ),
          ...
          _section(theme,
            title: '3. Payments',
            body: 'Payments for completed jobs are processed through the platform. Standard payment terms are net-7 for approved jobs. Phoebe retains a service fee as disclosed in your agreement. Disputes must be reported within 48 hours of job completion.',
          ),
          const SizedBox(height: 20),
          _section(theme,
            title: '4. Conduct',
          ...
          _section(theme,
            title: '5. Liability',
            body: 'Workers are responsible for their own work and carry appropriate liability insurance. Phoebe is not liable for damages arising from work performed. Workers indemnify Phoebe against claims arising from their services.',
          ),
          const SizedBox(height: 20),
          _section(theme,
            title: '6. Termination',
            body: 'Either party may terminate this agreement at any time. Phoebe reserves the right to deactivate workers for violating these terms. Upon termination, outstanding payments for completed work will be settled.',
          ),
        ],
      ),
    );
