            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Phoebe AI is analyzing your image...',
                    style: theme.textTheme.bodyMedium?.copyWith(
                      fontWeight: FontWeight.bold,
                      color: theme.colorScheme.onSurface,
                    ),
              ...
              child: Column(
                ...
                children: [
                  if (_selectedImageBytes != null) ...[
                    ...
                    // No photo selected
                    Text(
                      'Let Phoebe AI scan a photo to estimate severity, parts, and duration instantly.',
                      textAlign: TextAlign.center,
                      style: theme.textTheme.bodyMedium?.copyWith(
                        fontSize: 12,
                        color: theme.colorScheme.onSurfaceVariant,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Phoebe operates between 1 PM and 10 PM. Requests placed outside working hours will be reviewed next morning.',
                    style: TextStyle(
                      fontSize: 10,
