...
import 'package:phoebe_core/ui/features/staff/views/admin_jobs_view.dart';
...
class _StubAuthRepository implements AuthRepository {
  ...
  @override
  Future<AppUser> signInWithEmail({required String email, required String password}) => throw UnimplementedError();
  @override
  Future<AppUser> signUpWithEmail({required String email, required String password, required String name, required UserRole role}) => throw UnimplementedError();
  @override
