...
import 'package:phoebe_core/data/repositories/collections_repository.dart';
...
import 'package:phoebe_core/ui/features/collections/view_models/collections_view_model.dart';
...
class StubAuthRepository implements AuthRepository {
  ...
  @override
  Future<AppUser> signInWithEmail({required String email, required String password}) async => throw UnimplementedError();
  @override
  Future<AppUser> signUpWithEmail({required String email, required String password, required String name, required UserRole role}) async => throw UnimplementedError();
  @override
