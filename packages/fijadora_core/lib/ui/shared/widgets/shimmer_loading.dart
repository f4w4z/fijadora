...
/// Full-page skeleton for [CollectionDetailView] — shown while the cover
/// image is loading to prevent a jarring pop-in of content.
class ShimmerCollectionDetail extends StatelessWidget {
  const ShimmerCollectionDetail({super.key});

  @override
  Widget build(BuildContext context) {
    final pad = 24.0;
    final coverHeight = MediaQuery.of(context).size.height * 0.30;
        ...
        children: [
          ...
          Padding(
            ...
            child: const Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                SkeletonBox(width: 220, height: 26, borderRadius: 6),
                SizedBox(height: AppSpacing.sm),
                Row(
                  children: [
                    SkeletonBox(width: 28, height: 28, borderRadius: 14), // avatar
                    SizedBox(width: AppSpacing.sm),
                ...
                // ── Category + item count chips + follow button ───────────
                Row(
                  children: [
                ...
                child: Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 12),
                      SkeletonBox(width: 44, height: 28, borderRadius: 8),
                    ],
                  ),
                ),
              )),
