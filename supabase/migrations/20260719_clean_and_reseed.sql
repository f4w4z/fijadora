-- Migration: Clean all seed data and reseed with 4 fresh user profiles
-- WARNING: This DELETES ALL EXISTING DATA from application tables.

-- 1. Clean all application data
DELETE FROM property_occupants;
...
-- 4. Seed a property for Sarah Manager
INSERT INTO properties (id, name, address, manager_id) VALUES
  ('00000000-0000-0000-0000-000000000005', 'Oakwood Heights', '742 Evergreen Terrace, Springfield', '00000000-0000-0000-0000-000000000002')
ON CONFLICT (id) DO NOTHING;

-- 5. Link Jane Customer as a tenant of that property
INSERT INTO property_occupants (property_id, user_id, role) VALUES
  ('00000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000004', 'tenant')
...
-- (seed.sql is not updated automatically; manual sync needed if local reset is used)
